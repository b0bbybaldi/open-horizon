...
CONFIG='{"log_level":"'${LOG_LEVEL:-}'","debug":'${DEBUG:-false}',"period":'${FFT_PERIOD:-0}',"type":"'${FFT_ANOMALY_TYPE:-none}'","level":'${FFT_ANOMALY_LEVEL:-0}',"mock":'${FFT_ANOMALY_MOCK:-false}',"raw":'${FFT_INCLUDE_RAW:-false}',"wav":'${FFT_INCLUDE_WAV:-false}',"services":'"${SERVICES:-null}"'}'
